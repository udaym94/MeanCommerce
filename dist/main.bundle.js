...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_14__registration_service__["a" /* RegistrationService */], __WEBPACK_IMPORTED_MODULE_15__login_service__["a" /* LoginService */]],
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.createUser = function (user) {
        alert(user.name + ' ' + user.email + ' ' + user.password + ' ' + user.email);
